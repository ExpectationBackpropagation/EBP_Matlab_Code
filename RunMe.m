...
Runs=1; %number of blocks to generate
...
[M,N,size_data,Test_ratio] = Get_dataset_properties(dataset);
...
Rep_num=1;% for K-fold cross valdiation, choose  Rep_num=1/Test_ratio, and Test_ratio=1/K;
